...
const CreateAccessory = ({user, cars}) => {
    ...
    const handleSubmit = (event) => {
        ...
        router.post('/accessories', accessory);
    }

    return (
        <div>
            <Authenticated user={user}>
                <Head title='Create new accessory' />
						...
						<form onSubmit={handleSubmit}>
							<div className="grid gap-6 mb-6 md:grid-cols-1">
								<div>
									...
									<input type="text" name="name" onChange={handleChange} id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Name" required/>
								</div>
								<div>
                                ...
                                <div>
                                    ...
                                    <select name='car_id' onChange={handleChange} id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        {cars.map(car => (
